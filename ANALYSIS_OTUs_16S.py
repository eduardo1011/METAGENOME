...
os.makedirs('plots_otu/rarefaction',exist_ok=True)
os.makedirs('plots_otu/indices',exist_ok=True)
os.makedirs('plots_otu/richness',exist_ok=True)
os.makedirs('plots_otu/taxonomy',exist_ok=True)
...
def button_clicked(b):
    ...
    with open('tablas/OTUs_data_for_rarefaction.json', 'r') as fp:
    ...
    with RARE_output:
        ...
        def button_clicked1(b):
            with output1:
                ...
                fig1.savefig('plots_otu/rarefaction/'+nombre_grafico+'.png', dpi = 900, bbox_inches= 'tight')
        ...
        def button_clicked2(b):
            with output2:
                ...
                if filename_plot.value is not '':
                    nombre_grafico = filename_plot.value
                fig1.savefig('plots_otu/rarefaction/'+nombre_grafico+'.jpeg', dpi = 900, bbox_inches= 'tight')
        ...
        def button_clicked3(b):
            with output3:
                ...
                if filename_plot.value is not '':
                    nombre_grafico = filename_plot.value
                fig1.savefig('plots_otu/rarefaction/'+nombre_grafico+'.svg', dpi = 900, bbox_inches= 'tight')
        ...
        def button_clicked4(b):
            with output4:
                ...
                if filename_plot.value is not '':
                    nombre_grafico = filename_plot.value
                fig1.savefig('plots_otu/rarefaction/'+nombre_grafico+'.pdf', dpi = 900, bbox_inches= 'tight')
        ...
        def button_clicked5(b):
            with output5:
                ...
                if filename.value is '':
                    nombre_archivo = 'Rarefy_chart_params_OTUs.txt'
                if filename.value is not '':
                    nombre_archivo = filename.value

                with open('plots_otu/rarefaction/'+nombre_archivo, 'w') as fq:
                    fq.write('#Saved parameters\n')
                    fq.write('Clustering:OTUs\n' )
                    """
...
def button_clicked(b):
    with help1_button_output:
        ...
        text2.insert(END, "For this analysis the OTUs were collapsed to species taking those with\n"                     "the most readings, from these a fasta file was built\n"                     "which was aligned using Clustalo.\n\n", 'text')
        ...
        text2.insert(END, "\n\nYou can see the file called OTUs_Phylogenetic_tree_VIEW_Species.txt\n"                     "deposited in the clustering folder.\n", 'text')
...
def button_clicked(b):
    ...
    with alfa_filo_output:
        ...
        fasta = open('clustering/OTUs.fasta')
        fastas = fasta.read()
        fasta.close()
        def find_seq(iden = ''):
        ...
        progreso.value = '<font color = limegreen> <b style="font-size:0.5vw">Process: </b> <font color = black> <b style="font-size:0.5vw"> OTUs_Phylogenetic_Diversity.fasta </b>'
        
        with open('clustering/OTUs_Phylogenetic_Diversity.fasta', 'w') as fq:
        ...
        with open('tablas/otu_species_dict.json', 'w') as fp:
        ...
        """
        #----------------
        info10 = subprocess.Popen('binarios/clustalo.exe --infile clustering/OTUs_Phylogenetic_Diversity.fasta --threads 8 --MAC-RAM 8000 --verbose --guidetree-out clustering/OTUs_Phylogenetic_Diversity_tree.txt --outfmt clustal --force --resno --outfile clustering/OTUs_Phylogenetic_Diversity_alig.txt --output-order tree-order --seqtype dna',
                        stdout=subprocess.PIPE, stderr=subprocess.PIPE)
        info100 = info10.communicate()[0].decode()
        

        arbol1 = open('clustering/OTUs_Phylogenetic_Diversity_tree.txt', 'r')
        arbol = arbol1.read()
        arbol1.close()
        ...
        PD.to_csv('tablas/OTUs_PD.txt',index = None, sep = '\t')
...
def button_clicked(b):
    ...
    with open('tablas/otu_species_dict.json', 'r') as fp:
        asv_species_dict = json.load(fp)
    
    with view_tree_output:
        clear_output(True)

        arbol11 = open('clustering/OTUs_Phylogenetic_Diversity_tree.txt', 'r')
        arb = ''
        for line in arbol11:
            line = line.rstrip()
            if re.search('OTU\d+', line):
                arb += re.sub('OTU\d+', asv_species_dict[re.search('OTU\d+', line).group()], line)
            else:
                arb += line
        arb = re.sub(';$', 'root;', arb)
        
        with open('clustering/OTUs_Phylogenetic_tree_VIEW_Species.txt', 'w') as fq:
            fq.write(arb)
        ...
        with open('clustering/OTUs_Phylogenetic_tree_VIEW.txt', 'w') as fq:
            fq.write(tree2.ascii_art())

        os.system('start notepad.exe clustering/OTUs_Phylogenetic_tree_VIEW.txt')
...
def button_clicked(b):
    ...
    with indices_button_output:
        ...
        Indices.to_csv('tablas/OTUs_Indices.txt',index = None, sep = '\t')
    ...
    with INDICES_output:
        ...
        def button_clicked1(b):
            with output1:
                ...
                if filename_plot.value is not '':
                    nombre_grafico = filename_plot.value
                fig2.savefig('plots_otu/indices/'+nombre_grafico+'.png', dpi = 900, bbox_inches= 'tight')
        ...
        def button_clicked2(b):
            with output2:
                ...
                if filename_plot.value is not '':
                    nombre_grafico = filename_plot.value
                fig2.savefig('plots_otu/indices/'+nombre_grafico+'.jpeg', dpi = 900, bbox_inches= 'tight')
        ...
        def button_clicked3(b):
            with output3:
                ...
                if filename_plot.value is not '':
                    nombre_grafico = filename_plot.value
                fig2.savefig('plots_otu/indices/'+nombre_grafico+'.svg', dpi = 900, bbox_inches= 'tight')
        ...
        def button_clicked4(b):
            with output4:
                ...
                if filename_plot.value is not '':
                    nombre_grafico = filename_plot.value
                fig2.savefig('plots_otu/indices/'+nombre_grafico+'.pdf', dpi = 900, bbox_inches= 'tight')
        ...
        def button_clicked5(b):
            with output5:
                ...
                if filename.value is '':
                    nombre_archivo = 'Indices_chart_params_OTUs.txt'
                if filename.value is not '':
                    nombre_archivo = filename.value
                
                with open('plots_otu/indices/'+nombre_archivo, 'w') as fq:
                    fq.write('#Saved parameters\n')
                    fq.write('Clustering:OTUs\n' )
                    """
                    diccionario para guardar en un archivo los parametros usados para volver a reproducirlos posteriormente
...
def button_clicked(b):
    ...
    with RICHNESS_output:
        ...
        def updata_plot(tipo_kits_1, IndicE, VariablE, SignificanciA, mostrat_SignificanciA, width_box, ticklabels_Y):
            ...
            def button_clicked5(b):
                with output5:
                    ...
                    if filename.value is '':
                        nombre_archivo = 'Richness_chart_params_OTUs.txt'
                    if filename.value is not '':
                        nombre_archivo = filename.value
                    
                    with open('plots_otu/richness/'+nombre_archivo, 'w') as fq:
                        fq.write('#Saved parameters\n')
                        fq.write('Clustering:OTUs\n' )
                        """
                        diccionario para guardar en un archivo los parametros usados para volver a reproducirlos posteriormente
        ...
        out_updata_plot = widgets.interactive_output(updata_plot, {'tipo_kits_1':tipo_kits_1, 'IndicE':IndicE, 'VariablE':VariablE,
                                                                  'SignificanciA':SignificanciA, 'mostrat_SignificanciA':mostrat_SignificanciA, 'width_box':width_box, 'ticklabels_Y':ticklabels_Y}) 
...
def SELECTSAM(SAM_SELECT = ''):
    sumary111 = []
    with open('plots_otu/taxonomy/AAAbundancEEE.txt', 'r') as fq:
    ...
    def salvarpng():
        ...
        figure.savefig('plots_otu/taxonomy/'+SAM_SELECT+'_'+Data+'_'+Linaje+'_'+Porcentaje+'_'+datetime.datetime.now().strftime('%d.%B.%Y_%I-%M%p')+'.png', dpi = 900, bbox_inches= 'tight')
    ...
    def salvarjpeg():
        ...
        figure.savefig('plots_otu/taxonomy/'+SAM_SELECT+'_'+Data+'_'+Linaje+'_'+Porcentaje+'_'+datetime.datetime.now().strftime('%d.%B.%Y_%I-%M%p')+'.jpeg', dpi = 900, bbox_inches= 'tight')
    ...
    def salvarsvg():
        ...
        figure.savefig('plots_otu/taxonomy/'+SAM_SELECT+'_'+Data+'_'+Linaje+'_'+Porcentaje+'_'+datetime.datetime.now().strftime('%d.%B.%Y_%I-%M%p')+'.svg', dpi = 900, bbox_inches= 'tight')
    ...
    def salvarpdf():
        ...
        figure.savefig('plots_otu/taxonomy/'+SAM_SELECT+'_'+Data+'_'+Linaje+'_'+Porcentaje+'_'+datetime.datetime.now().strftime('%d.%B.%Y_%I-%M%p')+'.pdf', dpi = 900, bbox_inches= 'tight')
...
def chord_plot():
    ...
    def on_select(event):
        ...
        def on_select2():
            fig.savefig('plots_otu/taxonomy/Chord_'+title_kit+'_'+Data+'_'+Linaje+'_'+Porcentaje+'_'+datetime.datetime.now().strftime('%d.%B.%Y_%I-%M%p')+'.png', dpi = 900, bbox_inches= 'tight')
        ###############
        ###############
        ...
        def on_select3():
            fig.savefig('plots_otu/taxonomy/Chord_'+title_kit+'_'+Linaje+'_'+Porcentaje+'_'+datetime.datetime.now().strftime('%d.%B.%Y_%I-%M%p')+'.jpeg', dpi = 900, bbox_inches= 'tight')
        ###############
        ###############
        ...
        #-------------------------------------
        def on_select4():
            fig.savefig('plots_otu/taxonomy/Chord_'+title_kit+'_'+Linaje+'_'+Porcentaje+'_'+datetime.datetime.now().strftime('%d.%B.%Y_%I-%M%p')+'.svg', dpi = 900, bbox_inches= 'tight')
        ###############
        ###############
        ...
        #-------------------------------------
        def on_select5():
            fig.savefig('plots_otu/taxonomy/Chord_'+title_kit+'_'+Linaje+'_'+Porcentaje+'_'+datetime.datetime.now().strftime('%d.%B.%Y_%I-%M%p')+'.pdf', dpi = 900, bbox_inches= 'tight')
        ###############
        ###############
    ...
    def on_select2():
        fig.savefig('plots_otu/taxonomy/Chord_'+title_kit+'_'+Linaje+'_'+Porcentaje+'_'+datetime.datetime.now().strftime('%d.%B.%Y_%I-%M%p')+'.png', dpi = 900, bbox_inches= 'tight')
    ...
    group_aspect = LabelFrame(root, text = ' CHORD PLOT:  '+title_kit+' ', font=("Arial", 10,  "bold"), height = 5, fg = 'black', bg = 'blue')
...
def button_clicked(b):
    ...
    with TAXONOMY_output:
        ...
        def TaxonomY(tipo_kits_1, tax, PercentagE, METODO, METRICA, para_mostrar, Multiple_colorS, tam_plot1, width_linea, Variables_metadatA, family_axis, displacement_leye,
            ...
            if para_mostrar == 'All':
                AAAbundancEEE.to_csv('plots_otu/taxonomy/AAAbundancEEE.txt', sep = '\t')
                pass
            ...
            with open('plots_otu/taxonomy/dict_para_salvar.json', 'w') as fp:
            ...
            if 'None' in Variables_metadatA:
                with open('plots_otu/taxonomy/dict_variable_element_colors.json', 'w') as fp:
            ...
            with open('plots_otu/taxonomy/dict_variable_element_colors_ALL.json', 'w') as fp:
                json.dump(VVVVV, fp)
            ...
            def button_clicked5(b):
                with output5:
                    ...
                    if filename.value is '':
                        nombre_archivo = 'Taxonomy_chart_params_OTUs.txt'
                    if filename.value is not '':
                        nombre_archivo = filename.value
                    
                    with open('plots_otu/taxonomy/'+nombre_archivo, 'w') as fq:
                        fq.write('#Saved parameters\n')
                        fq.write('Clustering:OTUs\n' )
                        """
                        diccionario para guardar en un archivo los parametros usados para volver a reproducirlos posteriormente
...
def button_clicked(b):
    ...
    with open('plots_otu/taxonomy/dict_variable_element_colors_ALL.json', 'r') as fp:
        dict_variable_element_colors = json.load(fp)
            ...
            if tipo_kits_1 in ['DNPowerSoil', 'DNMicrobial'] and VariablE == 'Genomic DNA kit':
                    ...
                    def BetA2(markers_point, size_point, alfa_point, alfa_linea, ver_num_muestra, ver_dendograma, ver_var_name,
                        ...
                        def button_clicked1(b):
                            with output1:
                                ...
                                fig.savefig('plots_otu/beta_diversity/'+nombre_grafico+'.png', dpi = 900, bbox_inches= 'tight')
                        ...
                        def button_clicked2(b):
                            with output2:
                                ...
                                fig.savefig('plots_otu/beta_diversity/'+nombre_grafico+'.jpeg', dpi = 900, bbox_inches= 'tight')
                        ...
                        def button_clicked3(b):
                            with output3:
                                ...
                                fig.savefig('plots_otu/beta_diversity/'+nombre_grafico+'.svg', dpi = 900, bbox_inches= 'tight')
                        ...
                        def button_clicked4(b):
                            with output4:
                                ...
                                fig.savefig('plots_otu/beta_diversity/'+nombre_grafico+'.pdf', dpi = 900, bbox_inches= 'tight')
                        ...
                        def button_clicked5(b):
                            with output5:
                                ...
                                if filename.value is '':
                                    nombre_archivo = 'Beta_diversity_no_phyl_chart_params_OTUs.txt'
                                if filename.value is not '':
                                    nombre_archivo = filename.value

                                with open('plots_otu/beta_diversity/'+nombre_archivo, 'w') as fq:
                                    fq.write('#Saved parameters\n')
                                    fq.write('Clustering:OTUs\n' )
                                    """
                                    diccionario para guardar en un archivo los parametros usados para volver a reproducirlos posteriormente
                ...
                if select_PCA == '3Di':
                    ...
                    def button_clicked11(b):
                        with output11:
                            clear_output(True)
                            plotly.offline.plot(FigurA, filename = 'plots_otu/beta_diversity/3Di_'+tipo_kits_1+'_'+re.sub('[/]|[(]|[)]|[*]|[|]', '_', VariablE)+'_OTUs'+datetime.datetime.now().strftime('%d.%B.%Y_%I-%M%p')+'.html', auto_open=False)
            ...
            if tipo_kits_1 in ['DNPowerSoil', 'DNMicrobial'] and VariablE == 'Genomic DNA kit':
                    ...
                    def BetA2(markers_point, size_point, alfa_point, alfa_linea, ver_num_muestra, ver_dendograma, ver_var_name,
                        ...
                        def button_clicked5(b):
                            with output5:
                                ...
                                if filename.value is '':
                                    nombre_archivo = 'Beta_diversity_phyl_chart_params_OTUs.txt'
                                if filename.value is not '':
                                    nombre_archivo = filename.value
                ...
                if select_PCA == '3Di':
                    ...
                    def button_clicked11(b):
                        with output11:
                            clear_output(True)
                            plotly.offline.plot(FigurA, filename = 'plots_otu/beta_diversity/'+tipo_kits_1+'_'+re.sub('[/]|[(]|[)]|[*]|[|]', '_', VariablE)+'_OTUs'+datetime.datetime.now().strftime('%d.%B.%Y_%I-%M%p')+'.html', auto_open=False)
