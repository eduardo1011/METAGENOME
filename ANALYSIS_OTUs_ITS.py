...
threshold_box = Box(children=[VBox([blanca2, threshold])], layout=Layout(border='5px solid beige', width='1900px', height='170px'))





METAGENOMIC_ITS_OTUs = VBox([threshold_box, blanca2, RESULTS_16S])
